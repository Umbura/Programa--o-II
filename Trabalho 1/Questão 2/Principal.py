...
if agencia1:
    for conta_obj in agencia1.lista_contas:
        if isinstance(conta_obj, Poupanca):
            ...
            print(f"   - Juros de {taxa_juros*100}% rendidos na Conta Poupança {conta_obj.numero}. Saldo anterior: R${saldo_anterior:.2f}, Saldo novo: R${conta_obj.saldo:.2f}")
...
if agencia1 and agencia1.lista_contas:
    ...
    print(f"   - Removida conta {conta_removida_ag1.numero} da Agência {agencia1.numero}")
if agencia2 and agencia2.lista_contas:
    conta_removida_ag2 = agencia2.lista_contas.pop(0)
    print(f"   - Removida conta {conta_removida_ag2.numero} da Agência {agencia2.numero}")
...
if banco_principal.lista_agencias:
    agencia_removida = banco_principal.lista_agencias.pop(0)
